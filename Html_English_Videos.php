...
$FindVideos="SELECT*FROM videos WHERE LanguageName='Html'and VideoVersion='English' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='Html' and VideoVersion='English' ";
