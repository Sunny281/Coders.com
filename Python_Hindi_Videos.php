...
$FindVideos="SELECT*FROM videos WHERE LanguageName='python'and VideoVersion='Hindi' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='python' and VideoVersion='Hindi' ";
