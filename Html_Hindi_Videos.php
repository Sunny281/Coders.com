...
$FindVideos="SELECT*FROM videos WHERE LanguageName='Html'and VideoVersion='Hindi' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='Html' and VideoVersion='Hindi' ";
