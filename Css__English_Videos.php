...
$FindVideos="SELECT*FROM videos WHERE LanguageName='Css'and VideoVersion='English' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='Css' and VideoVersion='English' ";
