...
$FindVideos="SELECT*FROM videos WHERE LanguageName='python'and VideoVersion='English' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='python' and VideoVersion='English' ";
