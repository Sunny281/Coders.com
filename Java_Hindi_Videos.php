...
$FindVideos="SELECT*FROM videos WHERE LanguageName='Java'and VideoVersion='Hindi' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='Java' and VideoVersion='Hindi' ";
