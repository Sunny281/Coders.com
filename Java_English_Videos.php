...
$FindVideos="SELECT*FROM videos WHERE LanguageName='Java'and VideoVersion='English' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='Java' and VideoVersion='English' ";
