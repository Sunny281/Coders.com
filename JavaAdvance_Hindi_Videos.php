...
$FindVideos="SELECT*FROM videos WHERE LanguageName='JavaAdvance'and VideoVersion='Hindi' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='JavaAdvance'and VideoVersion='Hindi' ";
