...
$FindVideos="SELECT*FROM videos WHERE LanguageName='CLanguage'and VideoVersion='Hindi' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='CLanguage' and VideoVersion='Hindi' ";
