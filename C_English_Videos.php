...
$FindVideos="SELECT*FROM videos WHERE LanguageName='CLanguage'and VideoVersion='English' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='CLanguage' and VideoVersion='English' ";
