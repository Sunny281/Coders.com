...
$FindVideos="SELECT*FROM videos WHERE LanguageName='JavaScript'and VideoVersion='Hindi' ";
...
$FindVideo="SELECT*FROM videos WHERE LanguageName='Css' and VideoVersion='Hindi' ";
